...
###################################################
### code chunk number 36: seqselect-ranges
###################################################
...
###################################################
### code chunk number 37: bracket-ranges
###################################################
xRle[irextract]


###################################################
### code chunk number 38: overlap-ranges
###################################################
...
###################################################
### code chunk number 39: ranges-coverage
###################################################
cov <- coverage(ir)
plotRanges(ir)
cov <- as.vector(cov)
...
###################################################
### code chunk number 40: ranges-shift
###################################################
shift(ir, 10)


###################################################
### code chunk number 41: ranges-plus
###################################################
ir + seq_len(length(ir))


###################################################
### code chunk number 42: ranges-asterisk
###################################################
ir * -2 # half the width


###################################################
### code chunk number 43: ranges-narrow
###################################################
narrow(ir, start=1:5, width=2)


###################################################
### code chunk number 44: ranges-threebands
###################################################
threebands(ir, start=1:5, width=2)


###################################################
### code chunk number 45: ranges-restrict
###################################################
restrict(ir, start=2, end=3)


###################################################
### code chunk number 46: ranges-disjoin
###################################################
disjoin(ir)
...
###################################################
### code chunk number 47: ranges-disjointBins
###################################################
disjointBins(ir)


###################################################
### code chunk number 48: ranges-reflect
###################################################
reflect(ir, IRanges(start(ir), width=width(ir)*2))


###################################################
### code chunk number 49: ranges-flank
###################################################
flank(ir, width = seq_len(length(ir)))


###################################################
### code chunk number 50: ranges-gaps
###################################################
...
###################################################
### code chunk number 51: ranges-pgap
###################################################



###################################################
### code chunk number 52: ranges-union
###################################################



###################################################
### code chunk number 53: ranges-punion
###################################################



###################################################
### code chunk number 54: ranges-intersect
###################################################



###################################################
### code chunk number 55: ranges-pintersect
###################################################



###################################################
### code chunk number 56: ranges-setdiff
###################################################



###################################################
### code chunk number 57: ranges-psetdiff
###################################################



###################################################
### code chunk number 58: Views-constructors
###################################################
...
###################################################
### code chunk number 59: views-looping
###################################################
...
###################################################
### code chunk number 60: RangedData-construct
###################################################
...
###################################################
### code chunk number 61: RangedData-construct-space
###################################################
rd <- RangedData(ir, name = letters[seq_len(length(ir))], values, 
...
###################################################
### code chunk number 62: RangedData-ranges
###################################################
ranges(rd)


###################################################
### code chunk number 63: RangedData-values
###################################################
values(rd)


###################################################
### code chunk number 64: RangedData-subspace
###################################################
rd["chr1"]


###################################################
### code chunk number 65: RangedData-subspace-2
###################################################
...
###################################################
### code chunk number 66: RangedData-names
###################################################
names(rd)


###################################################
### code chunk number 67: RangedData-length
###################################################
length(rd)


###################################################
### code chunk number 68: RangedData-lapply
###################################################
lapply(rd, names)


###################################################
### code chunk number 69: RangedData-extract
###################################################
rd[[2]]


###################################################
### code chunk number 70: RangedData-dollar
###################################################
rd$values


###################################################
### code chunk number 71: RangedData-subset-2d
###################################################
rd[1:3, "name"]


###################################################
### code chunk number 72: sessionInfo
###################################################
toLatex(sessionInfo())
